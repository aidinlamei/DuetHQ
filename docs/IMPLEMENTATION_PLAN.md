...
- [x] **P1-02 Test infrastructure**
  ...
  - B (after A was green on Ubuntu CI). Implemented; green on GitHub Actions (run for `9fb88ae`, 2026-09-21; container steps: image pull 6 s, integration tests 6 s, whole job 62 s):
